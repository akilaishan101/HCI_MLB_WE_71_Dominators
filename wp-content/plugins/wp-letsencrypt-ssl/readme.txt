...
Tags: ssl,free ssl,https,mixed content,ssl certificate,https redirect,force ssl,enable ssl,security,insecure content,force ssl,lets encrypt,install ssl,enable https
...
One click SSL - Install free Let's Encrypt SSL certificate and force SSL / HTTPS, fixing insecure content & mixed content issues easily.

== Description ==

Generate free Let's Encrypt SSL certificate for your WordPress site in One Click and force SSL/HTTPS, fixing insecure content & mixed content issues easily.
...
4. (Optional) Running WordPress on a specialized VPS/Dedicated server without cPanel? You can download the generated SSL certificate files easily via our plugin page and install it on your server by modifying server config file via SSH access as explained in our [DOCS](https://wpencryption.com/docs/?utm_campaign=wpencryption&utm_medium=readmedocs&utm_source=wordpress). 
...
6. Top notch one to one priority support
...
Some helpful tutorials for non cPanel based SSL installations can be found on our [DOCS](https://wpencryption.com/docs/?utm_campaign=wpencryption&utm_source=wordpress&utm_medium=faqdocs).
