...
class WPLE_Subdir_Challenge_Helper
{
    ...
    <div id="wple-error-popper">    
      <div class="wple-flex">
        ...
        <div class="wple-upgrade-features">
          ...
          <span><b>7 Days</b><br>Free Trial</span>          
    ...
    <button id="verify-subhttp" class="subdir_verify"><span class="dashicons dashicons-update"></span>&nbsp;' . esc_html__( 'Verify HTTP Challenges', 'wp-letsencrypt-ssl' ) . '</button>

    <div class="http-notvalid">' . esc_html__( 'Could not verify HTTP challenges. Please check whether HTTP challenge files uploaded to acme-challenge folder is publicly accessible.', 'wp-letsencrypt-ssl' );
    ...
    <button id="verify-subdns" class="subdir_verify"><span class="dashicons dashicons-update"></span>&nbsp;' . esc_html__( 'Verify DNS Challenges', 'wp-letsencrypt-ssl' ) . '</button>
