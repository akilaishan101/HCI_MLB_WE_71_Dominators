...
*/ 
	...
	global $wpdp_premium_link, $wpdp_dir, $wpdp_url, $wpdp_pro, $wpdp_data, $wpdp_options, $wpdp_styles, $wpdp_android_settings, $wpdp_actual_link, $wpdp_new_js, $wpdp_new_cs, $wpdp_gen_file;
